...
BUILDDIR = build
TARGET = simplicial_complex_program
...
$(BUILDDIR)/$(TARGET): $(BUILDDIR)/utils_mod.o $(BUILDDIR)/sorted_list_mod.o $(BUILDDIR)/simplicial_complex_mod.o $(BUILDDIR)/main.o | $(BUILDDIR)
	$(FC) $(FCFLAGS) -o $@ $^
...
$(BUILDDIR)/simplicial_complex_mod.o: src/simplicial_complex_mod.f90 $(BUILDDIR)/sorted_list_mod.o $(BUILDDIR)/utils_mod.o| $(BUILDDIR)
	$(FC) $(FCFLAGS) -c $< -o $@
